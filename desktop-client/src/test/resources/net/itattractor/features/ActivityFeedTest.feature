...
Функционал: проверка функционала для полосы активности в ежедневном отчете пользователя
  ...
  | полоса активности №1 | 01.04.2014 15:01:00 | 01.04.2014 15:11:00 | 07/01/2014 |   1   |

  Структура сценария: Пользователь переходит на страницу тикета с полосы активности
    Допустим сделал рабочую запись "<work_log>" в "<start_time>"
    И активно работал над ней до "<end_time>"
    И открываю вкладку Tracker
  ...
  Примеры:
    ...
    | полоса активности №3 | 03.04.2014 15:01:00 | 03.04.2014 15:21:00 | 07/03/2014 |
